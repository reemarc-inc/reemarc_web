                        ...
                        <div class="card-body">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group" id="question_2" style="display: none;">
                                    <label style="font-size: medium; color: #b91d19;">2. What is the estimated treatment period?</label>
                                ...
                                <div class="form-group" id="question_3" style="display: none;">
                                    <label style="font-size: medium; color: #b91d19;">3. Have you received the aligners?</label>
                                    <select name="answer_3" id="answer_3" class="form-control" onchange="select_answer_3()">
                                        <option value="">Select</option>
                                        <option value="yes">YES</option>
                                        <option value="no">NO</option>
                                    </select>
                                ...
                                <div class="form-group" id="question_4" style="display: none;">
                                    <label style="font-size: medium; color: #b91d19;">4. When was the first appointment with aligner?</label>
...
<script type="text/javascript">
    ...
    function select_answer_3() {
        answer_3 = $('#answer_3 option:selected').val();

        if (answer_3 == 'no') {
            $("#question_4").fadeOut();
            $("#submit_btn").fadeIn(600);
        } else if(answer_3 == 'yes') {
