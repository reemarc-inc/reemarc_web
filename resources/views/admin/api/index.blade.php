...
{{--        </script>--}}
        ...
        <script type="text/javascript">
            ...
            function get_appointments_upcoming_list_profile_btn(){
                hide_search_box();
                $('#get_appointments_upcoming_list_profile_box').show();
                $('#api_link').val('/api/get_appointments_upcoming_list_profile');
            }

            function get_appointment_upcoming_list_profile(){

                var user_id = $('#get_appointments_upcoming_list_profile_user_id').val();
                if ($.trim(user_id) == '') {
                    return;
                }
                var data = {
                ...
                document.getElementById("input_json").innerHTML = JSON.stringify(data, undefined, 2);
                $.ajax({
                    url: '/api/get_appointments_upcoming_list_profile',
                    data: data,
                    cache: false,
                    type: 'post',
                    dataType: 'json',
            ...
            function get_appointments_complete_list_profile_btn(){
                hide_search_box();
                $('#get_appointments_complete_list_profile_box').show();
                $('#api_link').val('/api/get_appointments_complete_list_profile');
            }

            function get_appointment_complete_list_profile(){

                var user_id = $('#get_appointments_complete_list_profile_user_id').val();
                if ($.trim(user_id) == '') {
                    return;
                }
                var data = {
                ...
                document.getElementById("input_json").innerHTML = JSON.stringify(data, undefined, 2);
                $.ajax({
                    url: '/api/get_appointments_complete_list_profile',
                    data: data,
                    cache: false,
                    type: 'post',
                    dataType: 'json',
...
{{--                            <button class="btn btn-info" onclick="appt_complete()">Appt Complete</button>--}}
        ...
        <div class="container-fluid">
            <div class="well filter" style="padding-bottom:5px;">
                ...
                {{--get_appointments_upcoming_list_profile_box--}}
                <div id="get_appointments_upcoming_list_profile_box" style="display:none;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-11">
                                    <input type="text" style="margin-left: 5px; float:left;"
                                           class="form-control" id="get_appointments_upcoming_list_profile_user_id"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 16px;">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-md-4 control-label"></label>
                                <div class="col-md-8">
                                    <button class="btn btn-info" onclick="get_appointment_upcoming_list_profile()">Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                {{--get_appointments_complete_list_profile_box--}}
                <div id="get_appointments_complete_list_profile_box" style="display:none;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="col-md-1 control-label">User_ID</label>
                                <div class="col-md-11">
                                    <input type="text" style="margin-left: 5px; float:left;"
                                           class="form-control" id="get_appointments_complete_list_profile_user_id"/>
                                </div>
                            </div>
                        </div>
                    </div>
