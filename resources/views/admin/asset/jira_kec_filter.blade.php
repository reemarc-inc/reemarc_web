...
{{--            </select>--}}
        ...
        <div class="form-group col-md-2">
            <input type="text" name="q" class="design-field" id="q" placeholder="Patient Name" value="{{ !empty($filter['q']) ? $filter['q'] : '' }}">
        </div>

        <div class="form-group col-md-2">
            <input type="text" name="asset_id" class="design-field" id="asset_id" placeholder="Appointment ID" value="{{ !empty($filter['asset_id']) ? $filter['asset_id'] : '' }}">
        </div>
