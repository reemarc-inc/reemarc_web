...
<section class="section">
    ...
    <div class="section-body">
        ...
        @include('admin.asset.kpi_copy_filter')
                                ...
                                <tbody>
                                    ...
                                    @foreach ($asset_list as $asset)
                                        <tr>
                                            ...
                                            <td>{{ $target_at = date('m/d', strtotime($asset->copy_target_at)) }}
                                            </td>
                                            <td>
                                                <?php if($asset->copy_delay != 0) { ?>
                                                {{ $asset->copy_delay }}
                                                <?php } ?>
                                            </td>
                                            <td>{{ $real_target_at = date('m/d', strtotime($asset->copy_target_at. '+'. $asset->copy_delay .' weekdays')) }}</td>
                                            <?php $done_at = date('m/d', strtotime($asset->copy_done_at)); ?>
