                                            ...
                                            <div class="form-group" style="width: 100%;">
                                                ...
                                                <div style="float: right;">
                                                    <figure class="avatar mr-2 avatar-sm text-white"
                                                            style="background-color: #848484; font-size: 15px; margin-left: -15px; z-index: 1;"
                                                ...
                                                <div class="text-sm-left text-muted" style="float:left; margin-top: -1px;">
                                                    <figure class="avatar sm-2 text-white" style="width: 15px; height: 15px; background-color: #017cc2; font-size: small;" data-initial=""></figure>
                                                </div>
