...
{{--                                        </div>--}}
                ...
                <div class="col-md-3" >
                    <div class="card status_title">
                        <h5 class="status_name">PACKAGE OPTION READY</h5>
                    </div>
                    @foreach ($package_option_ready_list as $obj)
                        <div class="card">
                            <a href="{{ url('admin/treatments/'. $obj->treatment_id .'/edit')}}" style="text-decoration: none;">
                                <div class="card-body" style="padding-left: 10px; padding-right: 10px; margin-bottom: -25px;">
                                    <div class="media" style="padding-bottom: 0px;">
                ...
                <div class="col-md-3" >
                    <div class="card status_title">
                        <h5 class="status_name">PACKAGE OPTION SENT</h5>
                    </div>
                </div>

                <div class="col-md-3" >
                    <div class="card status_title">
                        <h5 class="status_name">PACKAGE IN PROGRESS</h5>
                    </div>
                </div>
