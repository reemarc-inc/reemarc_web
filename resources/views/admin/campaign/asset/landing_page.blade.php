    ...
    <div class="form-group">
        <table class="reminder_table">
            <tr>
                ...
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->launch_date . ' -47 days')); ?></b></span></td>
            </tr>
            <tr>
                <td><label><b>Creative Due:</b></label></td>
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->launch_date . ' -40 days')); ?></b></span></td>
            </tr>
            <tr>
                <td><label><b>Review Due:</b></label></td>
                <td style="color: #b91d19"><span><b><?php echo date('m/d/Y', strtotime($data[0][0]->launch_date . ' -12 days')); ?></b></span></td>
            </tr>
            <tr>
