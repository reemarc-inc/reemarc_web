<?php $asset_type = 'info_graphic'; ?>

<form method="POST" action="{{ route('campaign.add_info_graphic') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
        <label>Launch Date: (Lead Time 41 Days)</label>
...
<script type="text/javascript">
    // Lead time +41 days - Info Graphic (exclude weekend)
    $(function() {
        var count = 41;
        var today = new Date();
